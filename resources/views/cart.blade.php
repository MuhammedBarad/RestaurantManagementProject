        ...
        @if ($cartItems->count())
            ...
            <div class="container py-5">
                <div class="card col-md-6 col-12 offset-md-3">
                    <div class="card-body">
                        <h4 class="card-title mb-5 mx-2">BaraRast Wishlist <span class="text-secondary h5">- {{ $cartItems->count() }} Items</span></h4>
                        ...
                        @foreach ($cartItems as $item)
                            <div class="w-100 px-3 d-flex align-items-center py-3">
                                ...
                                <div class="col-6 px-4">
                                    ...
                                    <h5 class="text-secondary">TL {{ $item->menu->price * $item->quantity }}</h5>
                                </div>
                        ...
                        <div class="d-flex justify-content-between px-3 mt-5">
                            ...
                            <h5 class="text-dark">TL {{ $subtotal }}</h5>
                        </div>
