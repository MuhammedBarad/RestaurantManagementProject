    ...
    <div class="container">
        ...
        @else
            <div class="col-md-8 offset-md-2 col-12 text-center menu-type my-3">
                <form method="get" action="{{ route('filterMenu') }}">
                    <button type="submit" name="menuType" value="" class="btn btn-light menu-type-button" id="menu-edit" style="padding:10px 15px;margin-left:5px;margin-right:5px">All</button>
                    <button type="submit" name="menuType" value="Appetizer" class="btn btn-light menu-type-button" id="menu-edit" style="padding:10px;margin-right:5px">Appetizer</button>
                    <button type="submit" name="menuType" value="Sushi" class="btn btn-light menu-type-button" id="menu-edit" style="padding:10px;margin-right:5px">Sushi</button>
                    <button type="submit" name="menuType" value="Temaki" class="btn btn-light menu-type-button" id="menu-edit" style="padding:10px;margin-right:5px">Temaki</button>
                    <button type="submit" name="menuType" value="Bento" class="btn btn-light menu-type-button" id="menu-edit" style="padding:10px;margin-right:5px">Bento</button>
                    <button type="submit" name="menuType" value="Ramen" class="btn btn-light menu-type-button" id="menu-edit" style="padding:10px;margin-right:5px">Ramen</button>
                    <button type="submit" name="menuType" value="Beverage" class="btn btn-light menu-type-button" id="menu-edit" style="padding:10px;margin-right:5px">Beverage</button>
                    <button type="submit" name="menuType" value="Dessert" class="btn btn-light menu-type-button" id="menu-edit" style="padding:10px;margin-right:5px">Dessert</button>
                </form>
            </div>
        @endif
        ...
        @forelse ($menus as $menu)
            ...
            <div class="card col-md-3 col-6 d-flex align-items-center" style="border-radius:10px;">
                <div class="card-body w-100">
                    <form class="d-flex flex-column justify-content-between h-100" action="{{ route('addToCart') }}" method="post">
                        ...
                        <div class="d-flex justify-content-between">
                            <p class="card-text fs-5 fw-bold">TL {{ number_format($menu->price, 2) }}</p>
